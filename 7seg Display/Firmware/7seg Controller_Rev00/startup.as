	...
	; Compiler options:
	;
	; -o7seg Controller.cof -m7seg Controller.map --summary=default \
	; --output=default 7seg_Rev00.p1 Definitions_Rev00.p1 \
	; Interrupts_Rev00.p1 Routines_Rev00.p1 --chip=16F876A -P \
